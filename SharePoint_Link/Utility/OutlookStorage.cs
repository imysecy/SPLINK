...
{
    /// <summary>
    /// <c>OutlookStorage</c> class inherits <c>IDisposable</c>
    /// Implements the functions and properties related to outlook mailitem or attachment
    
    /// </summary>
    [Serializable()]
    class OutlookStorage : IDisposable
    {
        ...
        public class Message : OutlookStorage
        {
            ...
            {
                get { return this.GetMapiPropertyString(OutlookStorage.Sender_Email); }
            }

            public String ReceivedByEmail
            {
                get { return this.GetMapiPropertyString(OutlookStorage.ReceivedBy_Email); }
            }
            public String ReceivedByName
            {
                get { return this.GetMapiPropertyString(OutlookStorage.ReceivedBy_Name); }
            }

            public String EmailHeader
            {
                get { return this.GetMapiPropertyString(OutlookStorage.EmailHeader); }
            }
            ...
            public String SentDate
            {
                ...
                get
                {
                    String strdate = this.GetMapiPropertyString(OutlookStorage.SentDate);
            ...
            public String BCCTest
            {
                get { return this.GetMapiPropertyString(OutlookStorage.BCCPart); }
        ...
        private const string BCCPart = "0E02";

        //msg constants
        private const string PR_SUBJECT = "0037";
        private const string PR_BODY = "1000"; //"1000";
        private const string PR_RTF_COMPRESSED = "1009";
        private const string PR_SENDER_NAME = "0C1A";
        private const string Sender_Email = "0C1F";
        private const string ReceivedBy_Email = "0076";
        private const string ReceivedBy_Name = "0040";
        private const string SentDate = "007D";
        private const string EmailHeader ="007D";
        private const string Test = "1000";
